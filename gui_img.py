...
add_button = sg.Button(size = 2,tooltip = 'Add a Todo',key = 'Add', image_source = 'add.png', mouseover_colors= 'LightBlue2')
# a clickable button
...
complete_button = sg.Button(size = 2, key = 'Complete', image_source = 'complete.png', mouseover_colors= 'LightBlue2')
